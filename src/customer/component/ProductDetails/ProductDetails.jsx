  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Vida Loca</h1>
              <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Pack of 2 Men Solid Pure Cotton Straight Kurta"</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className='opacity-50 text-sm'>56098 Ratings</p>
        ...
        <section>
        <h1 className='font-semibold text-lg pb-4'>Recent rerview rating</h1>
        <div className='border p-5'>
            <Grid container spacing={7}>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <p className='opacity-60'>87653 Ratings</p>
                    </div>
      ...
      <section className='pt-10'>
          ...
          {mens_kurta.map((item)=><HomeSectionCart product={item}/>)}
          </div>
      </section>
